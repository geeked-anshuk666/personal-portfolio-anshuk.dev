...
const themeToggleDiv = document.getElementById("toggle-div");
...
const initTheme = () => {
    ...
    if (themeToggle) {
        ...
        themeToggleDiv.classList.toggle("night", theme === "dark");
    }
};
...
const toggleTheme = () => {
    ...
    if (themeToggleDiv) {
        themeToggleDiv.classList.toggle("night", newTheme === "dark");
    }
};
